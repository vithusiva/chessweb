                ...
                <div class="col-lg-6">
                   <div class="card bg-reef ht-400 wd-400 ">
                       <div class="card-header  tx-white bg-primary">
                             <h4><b ><?php echo e($post->TournamentName); ?></b><h4>
                       </div>
                       
                       <div class="card-body ">
                           <h6><b> Venue :  &nbsp; &nbsp;&nbsp;  </b> <?php echo e($post->Venue); ?>  </h6> 
                        
                           <h6><b>  Date :  &nbsp; &nbsp;&nbsp;  </b> <?php echo e($post->Date); ?></h6>
                        
                           <h6><b> Description :  &nbsp; &nbsp;&nbsp;  </b><?php echo e($post->Description); ?> </h6>
                        </div>
                        ...
                        <div class="  row mg-b-25 ">
                         <div class="col-lg-2">
                           <form action = "<?php echo e(route('post.destroy',$post ->id)); ?>" method = "POST" style="display:inline"onsubmit="if(!confirm('Are you sure')){return false;}">
                         ...
                         <div class="col-lg-2">
                            ...
                            <a href="<?php echo e(route('post.edit',$post ->id)); ?>" align right><button class="btn btn-oblong btn-outline-primary btn-block mg-b-10 wd-60 bd bd-4 bg-blue">Edit</button></a>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ChessAppPHP\resources\views/post/index1.blade.php ENDPATH**/ ?>