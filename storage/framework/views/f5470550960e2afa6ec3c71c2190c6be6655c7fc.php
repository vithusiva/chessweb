                    ...
                    <div class="modal-body pd-0">
                      <div class="row no-gutters">
                        <div class="col-lg-6 bg-primary">
                            <div class="pd-20" >
                                <img src="/admin/img/chesss19.jpg" width="350" height="400"/>
                            </div>
                        </div>
                        <!-- col-6 -->
                            ...
                            <div class="pd-y-30 pd-xl-x-30">
                              ...
                              <div class="pd-x-30 pd-y-10">
                                ...
                                <div class="form-group">
                                  <input type="email" name="email" class="form-control pd-y-12"value="<?php echo e(old('email')); ?>" required autofocus placeholder="Enter your email">
                                </div>
                                ...
                                <div class="form-group mg-b-20">
                                 ...
                                 <span class="help-block">
                                   <strong><?php echo e($errors->first('password')); ?></strong>
                                    ...
                                    <?php endif; ?>
                                  <a  href="<?php echo e(route('password.request')); ?>" class="tx-12 d-block mg-t-10">Forgot password?</a>
                                </div><!-- form-group -->

                                <button class="btn btn-primary pd-y-12 btn-block">Sign In</button>

                                <div class="mg-t-30 mg-b-20 tx-12">Don't have an account yet? <a href="<?php echo e(route('register')); ?>">Sign Up</a></div>
                              </div>
                            </div><!-- pd-20 -->
                          </div><!-- col-6 -->
                        </div><!-- row -->
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ChessAppPHP\resources\views/auth/login.blade.php ENDPATH**/ ?>