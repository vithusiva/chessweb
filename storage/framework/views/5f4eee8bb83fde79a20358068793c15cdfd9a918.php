            ...
            <div class="pd-l-100 row mg-b-25 ">
              <div class="col-lg-8">
                <div class="form-group">
                  ...
                  <input class="form-control bd bd-3" type="text" name="tname" id="tname" value="<?php echo e($post -> TournamentName); ?>"placeholder="Enter tournament name">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-8">
                <div class="form-group">
                  <label for ="date" class="form-control-label">Date </label>
                  <input name ="date" id="date" type="date" value="<?php echo e($post -> Date); ?>" class="form-control bd bd-3" placeholder="date">
              </div>
              </div><!-- col-4 -->
              <div class="col-lg-8">
                <div class="form-group">
                  <label for = "venue"class="form-control-label">Venue </label>
                  <input class="form-control bd bd-3" type="text" name="venue" value="<?php echo e($post -> Venue); ?>" id="venue" placeholder="Enter venue">
                </div>
              </div><!-- col-4 -->
              <div class="col-lg-8">
                <div class="form-group mg-b-10-force">
                  <label for = "des"class="form-control-label">Description</label>
                  <textarea rows="3" class="form-control is-valid mg-t-20 bd bd-3" name="des" id="des"  value="<?php echo e($post -> Description); ?>" placeholder="Textarea"></textarea>
                 </div>
                </div><!-- col-8 -->
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ChessAppPHP\resources\views/post/edit.blade.php ENDPATH**/ ?>