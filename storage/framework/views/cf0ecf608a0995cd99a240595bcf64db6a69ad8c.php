                        ...
                        <div class="form-group col-md-8">
                            ...
                            <select field="tiebreak_id" class="form-control" name = "tiebreak_id" id="tiebreak_id" required>
                                <?php $__currentLoopData = $tiebreaks; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tiebreak): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($tiebreak->id); ?>"><?php echo e($tiebreak->tiebreak_name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ChessAppPHP\resources\views/tournament/create.blade.php ENDPATH**/ ?>