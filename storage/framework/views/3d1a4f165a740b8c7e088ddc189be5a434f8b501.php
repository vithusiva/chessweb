                      ...
                      <div class="row no-gutters">
                        ...
                        <div class="col-lg-6 bg-white">
                            <div class="pd-y-30 pd-xl-x-30">
                                <form action="<?php echo e(route('student1.store')); ?>" method="POST" class="was-validated">
                                <?php echo e(csrf_field()); ?>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a href = "<?php echo e(route('student')); ?>" class="btn btn-sm btn-info">Back</a>
                                        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\ChessAppPHP\resources\views/post/studentapplication.blade.php ENDPATH**/ ?>