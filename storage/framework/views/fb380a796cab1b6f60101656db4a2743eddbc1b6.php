...
<head>
    ...
    <meta name="author" content="mydynamica">
  ...
  <body class="collapsed-menu-dd">
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="br-logo"><a href="#"><span>[</span>My <i>Admin</i><span>]</span></a></div>
    ...
    <div class="br-mainpanel" id="wrapper">
      ...
      <footer class="br-footer sticky-bottom">
        <div class="footer-left">
          <div class="mg-b-2">Copyright &copy; 2018. My Admin. All Rights Reserved.</div>
          <div>Attentively and carefully made by Mydynamica.</div>
        </div>
      </footer>
    </div><!-- br-mainpanel -->
    <!-- ########## END: MAIN PANEL ########## -->
...
<?php /**PATH M:\Project3rdYear\Laravel\ChessAppPHP\resources\views/admin/template.blade.php ENDPATH**/ ?>