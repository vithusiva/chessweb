<div class="br-header">
          ...
          <div class="dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-header wd-250">
              ...
              <ul class="list-unstyled user-profile-nav">
                <li><a href="/" target="_blank"><i class="icon ion-ios-glob"></i> Visit Site</a></li>
    ...
    </div><!-- br-header --><?php /**PATH M:\Project3rdYear\Laravel\ChessAppPHP\resources\views/admin/inc/top-nav.blade.php ENDPATH**/ ?>