    ...
    <form action="<?php echo e(route('player.update',$players->id)); ?>" method="post">
        ...
        <div class="row">
            <div class="form-group col-md-8">
                <label for="id" class="col-form-label">Player ID</label>
                <input type="text"  name = "id" id="id" value="<?php echo e($players->id); ?>" class="form-control" readonly = "readonly">
            </div>
            <div class="form-group col-md-8">
            ...
            <div class="form-group col-md-8" >
                ...
                <input type="radio"   name ="gender" value="Male"   value="<?php echo e($players->gender); ?>"> <label>Male</label>&nbsp;&nbsp;&nbsp;
...
<?php echo $__env->make('admin.template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH M:\Project3rdYear\Laravel\ChessAppPHP\resources\views/player/edit.blade.php ENDPATH**/ ?>